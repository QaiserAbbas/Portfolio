...
import { FaCode, FaSketch, FaAndroid, FaShopify, FaAppStore } from "react-icons/fa"
export default [
  {
    id: 1,
  ...
  },
  {
    ...
    text: `I provide iOS app development services. I can develops sophisticated back-end systems, and creates stunning user-friendly front-end interfaces. Proficient in iOS development using Objective-C and Swift programming languages for iPhone, iPad and Apple Watch devices with 6+ years of experience.
    `,
  },
]
