const blogs = [
  ...
  },
  {
    ...
    'image':'php.jpg',
    'content': `<h1 class="post-title" itemprop="name headline" style="margin-top: 40px"><span>How to use Composer and Packagist in PHP</span></h1><div class="clearfix post-content" itemprop="articleBody">
