...
<span class="token punctuation">)</span>
  ...
  },
  {
    ...
    'image':'useeffect.png',
    'content':`<h2 class="post-title" itemprop="name headline" style="margin-top: 40px"><span>How to use useEffect callback with event
    callbacks</span></h2>


<div class="clearfix post-content" itemprop="articleBody">

<p>I was running some code like this:</p>
<div class="highlight">
    <pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"
        class="language-js"><code class="language-js" data-lang="js"><span class="token function">useEffect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>socket<span class="token punctuation">)</span> <span class="token keyword">return</span>

socket<span class="token punctuation">.</span><span class="token function">on</span><span class="token punctuation">(</span><span class="token string">'newuserconnected'</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">username</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>connectedusers<span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">[</span>socket<span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre>
</div>
<p>to initialize a callback for an event <code>newuserconnected</code> on a socket.io connection.</p>
<p>I assumed that after doing so, any time I called that event on the server, the client-side (React app) would
    print the <strong>current value</strong> at runtime of the variable <code>connectedusers</code> (imagine I was
    updating it somewhere else in the app).</p>
<p>But no, the value of that variable was “stuck in time” at the moment I defined that event.</p>
<p>What I had to do to fix the problem was to add that variable value to the list of variables that the
    <code>useEffect</code> call depends on:</p>
<div class="highlight">
    <pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"
        class="language-js"><code class="language-js" data-lang="js"><span class="token function">useEffect</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
<span class="token comment">//...</span>
<span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token punctuation">[</span>socket<span class="token punctuation">,</span> connectedusers<span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre>
</div>
...
<div class="custom-slant"></div>
  ...
  },
  {
    ...
    'content':`<h2 class="post-title" itemprop="name headline" style="margin-top: 40px"><span>React, how to make responsive JSX</span>
    </h2>
    ...
    <div class="clearfix post-content" itemprop="articleBody">
        ...
        <p>I had the need to make a sidebar look in one particular way when in a big screen in React, and in another way
            when in a smaller screen, so I wanted to have some way to detect responsive layouts changes in <a
                href="/jsx/">JSX</a>.</p>
        <p>Like this:</p>
        <p><img src="Screen%20Shot%202021-07-07%20at%2015.56.21.png" alt=""></p>
        <p><img src="Screen%20Shot%202021-07-07%20at%2015.56.31.png" alt=""></p>
        <p>You can use the <a href="https://www.npmjs.com/package/react-responsive"><code>react-responsive</code></a>
            package to do that.</p>
        <pre tabindex="0"><code>npm install react-responsive
    </code></pre>
        <p>then you can import the <code>useMediaQuery</code> hook:</p>
        <div class="highlight">
            <pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"
                class="language-js"><code class="language-js" data-lang="js"><span class="token keyword">import</span> <span class="token punctuation">{</span> useMediaQuery <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'react-responsive'</span>
    </code></pre>
        </div>
        <p>And in your components you can use it like this:</p>
        <div class="highlight">
            <pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"
                class="language-jsx"><code class="language-jsx" data-lang="jsx">  const isBigScreen = useMediaQuery({ query: '(min-device-width: 1224px)' })
    const isSmallScreen = useMediaQuery({ query: '(max-width: 1224px)' })
    </code></pre>
        </div>
        <p>This is a simple example of breakpoints I found on the component’s home page, and they worked fine for my needs.
        </p>
        <p>I used it in a layout component in this way:</p>
        <div class="highlight">
            <pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"
                class="language-jsx"><code class="language-jsx" data-lang="jsx">import { useMediaQuery } from 'react-responsive'
    ...
    return (
      ...
      &lt;/div&gt;
        ...
        <p>I used it to pass a <code>small</code> prop to a <code>LeftSidebar</code> component, so it knew how to render
            itself.</p>
        <p>You can also do things differently and create components to wrap JSX, which I find nicer to see:</p>
        <div class="highlight">
            <pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4;"
                class="language-jsx"><code class="language-jsx" data-lang="jsx">import { useMediaQuery } from 'react-responsive'
