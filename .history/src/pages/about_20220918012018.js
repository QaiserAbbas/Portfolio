...
const About = () => {
  ...
  return (
    ...
    <p>Hi, I'm <strong>Qaiser</strong>, and I develop modern, robust, fast-loading, easy to manage sites using <strong>Shopify, WordPress, custom HTML/CSS/JS/ReactJs.</strong> </p>
    <p><strong>I'm confident with:</strong></p>
    <p>I always pursue a long-term relationship with great clients.</p>
    ...
    <p>Got an idea of a brand new iOS app? Or you want to add some features to your existing app?
        I look forward to hearing from you - let's bring your ideas to code!</p>
</div>
